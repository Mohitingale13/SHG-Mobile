...
function buildStandardPdfTemplate(params: {
  ...
  const footer = `
    <div style="font-size: 9px; color: #555; text-align: center; margin-bottom: 8px; font-style: italic;">
      ${t("pdf_historical_data_disclaimer", { defaultValue: "Note: Opening Balances in these reports inherently include all historical member contributions and loan repayments up to the date of SHG digitization on this platform." })}
    </div>
    <div class="footer">
