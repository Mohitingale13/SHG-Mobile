...
The **SHG Digital Record Platform** digitizes the financial and operational record-keeping of rural Self Help Groups. Moving away from manual ledger books, this platform automates contribution tracking, late fee generation, meeting attendance, and loan approvals. 

A unique feature of this platform is the **AI Voice Assistant**, designed specifically for users with lower digital literacy. By speaking in Marathi or English, members and presidents can ask the platform to instantly navigate to reports, request loans, or check payment statuses. 
...
- **SHG Creation**: Super Admins can instantiate new SHGs.
...
- **Member Registration**: Members join securely using limited-use Invitation Codes generated by the President.
...
graph TD
    ...
    C -->|Generates| D(Invitation Codes)
    D -->|Provides Codes| E[Members join using Invitation Codes]
