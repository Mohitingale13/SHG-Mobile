...
export const translations: Record<string, any> = {
  "bank_loan.allocated_members": { "en": "Allocated Members", "mr": "वाटप केलेले सदस्य" },
  "bank_loan.completed_allocations": { "en": "Completed Alloc.", "mr": "पूर्ण वाटप" },
  "migration.success_title": { "en": "Migration Completed", "mr": "स्थलांतर पूर्ण झाले" },
  "migration.success_desc": { "en": "Your SHG has been successfully migrated to the digital platform. You can now use all features normally.", "mr": "तुमच्या गटाचे डिजिटल प्लॅटफॉर्मवर यशस्वीरित्या स्थलांतर झाले आहे. तुम्ही आता सर्व वैशिष्ट्ये सामान्यपणे वापरू शकता." },
  "migration.completion_summary": { "en": "Completion Summary", "mr": "पूर्ततेचा सारांश" },
  "migration.completion_date": { "en": "Completion Date", "mr": "पूर्ततेची तारीख" },
  "migration.imported_members": { "en": "Imported Members", "mr": "आयात केलेले सदस्य" },
  "migration.imported_loans": { "en": "Imported Internal Loans", "mr": "आयात केलेली अंतर्गत कर्जे" },
  "migration.imported_bank_loans": { "en": "Imported Bank Loans", "mr": "आयात केलेली बँक कर्जे" },
  "migration.opening_snapshot": { "en": "Opening Snapshot", "mr": "सुरुवातीची स्थिती" },
  "migration.cash_in_hand": { "en": "Cash in Hand", "mr": "रोख रक्कम" },
  "migration.bank_balance": { "en": "Bank Balance", "mr": "बँक शिल्लक" },
  "migration.total_savings": { "en": "Total Savings", "mr": "एकूण बचत" },
  "migration.go_to_dashboard": { "en": "Go to Dashboard", "mr": "डॅशबोर्डवर जा" },
  "migration.historical_entry": { "en": "Historical Entry", "mr": "ऐतिहासिक नोंद" },
  "common.coming_soon": { "en": "Coming Soon", "mr": "लवकरच येत आहे" },
  "common.required": { "en": "Required", "mr": "आवश्यक" },
  "bank.bank_name": { "en": "Bank Name", "mr": "बँकेचे नाव" },
  "bank.branch": { "en": "Branch", "mr": "शाखा" },
  "common.save_next": { "en": "Save & Next", "mr": "सेव्ह करा आणि पुढे जा" },
  "common.delete": { "en": "Delete", "mr": "हटवा" },
  "common.confirm_delete": { "en": "Confirm Delete", "mr": "हटवण्याची खात्री करा" },
  "roles.president": { "en": "President", "mr": "अध्यक्ष" },
  "roles.secretary": { "en": "Secretary", "mr": "सचिव" },
  "roles.treasurer": { "en": "Treasurer", "mr": "खजिनदार" },
  "roles.member": { "en": "Member", "mr": "सदस्य" },
  "migration.members_added": { "en": "Members Added", "mr": "सदस्य जोडले" },
  "member.add_member": { "en": "Add Member", "mr": "सदस्य जोडा" },
  "migration.no_members": { "en": "No Members Added", "mr": "कोणतेही सदस्य जोडले नाहीत" },
  "member.edit_member": { "en": "Edit Member", "mr": "सदस्य संपादित करा" },
  "member.full_name": { "en": "Full Name", "mr": "पूर्ण नाव" },
  "member.mobile": { "en": "Mobile Number", "mr": "मोबाईल क्रमांक" },
  "member.joining_date": { "en": "Joining Date", "mr": "सामील होण्याची तारीख" },
  "loan.original_amount": { "en": "Original Amount", "mr": "मूळ रक्कम" },
  "loan.duration": { "en": "Duration (Months)", "mr": "कालावधी (महिने)" },
  "migration.active_loans": { "en": "Active Loans", "mr": "सक्रिय कर्जे" },
  "loan.apply_loan": { "en": "Add Loan", "mr": "कर्ज जोडा" },
  "migration.no_loans": { "en": "No Active Loans", "mr": "कोणतीही सक्रिय कर्जे नाहीत" },
  "loan.edit_loan": { "en": "Edit Loan", "mr": "कर्ज संपादित करा" },
  "loan.member_name": { "en": "Member Name", "mr": "सदस्याचे नाव" },
  "loan.loan_amount": { "en": "Loan Amount", "mr": "कर्जाची रक्कम" },
  "loan.outstanding_principal": { "en": "Outstanding Principal", "mr": "थकबाकी मुद्दल" },
  "loan.outstanding_interest": { "en": "Outstanding Interest", "mr": "थकबाकी व्याज" },
  "loan.remaining_months": { "en": "Remaining Months", "mr": "उर्वरित महिने" },
  "loan.resolution_no": { "en": "Resolution No.", "mr": "ठराव क्र." },
  "loan.disbursement_date": { "en": "Disbursement Date", "mr": "वितरण तारीख" },
  "bank.sanction_no": { "en": "Sanction No.", "mr": "मंजुरी क्र." },
  "migration.active_bank_loans": { "en": "Active Bank Loans", "mr": "सक्रिय बँक कर्जे" },
  "bank.add_bank_loan": { "en": "Add Bank Loan", "mr": "बँक कर्ज जोडा" },
  "migration.no_bank_loans": { "en": "No Active Bank Loans", "mr": "कोणतीही सक्रिय बँक कर्जे नाहीत" },
  "bank.edit_bank_loan": { "en": "Edit Bank Loan", "mr": "बँक कर्ज संपादित करा" },
  "migration.step1_desc": { "en": "Please verify the bank account details and formation date of the SHG.", "mr": "कृपया बँकेचा तपशील आणि गटाच्या स्थापनेची तारीख तपासा." },
  "migration.step2_desc": { "en": "Current SHG Financial Position", "mr": "गटाची सद्य आर्थिक स्थिती" },
  "migration.review_desc": { "en": "Please review all entered data. The migration is not finalized yet.", "mr": "कृपया प्रविष्ट केलेल्या सर्व डेटाचे पुनरावलोकन करा. स्थलांतर अद्याप अंतिम नाही." },
  "migration.has_cash": { "en": "Does the SHG currently keep physical cash?", "mr": "गटाकडे सध्या भौतिक रोख रक्कम आहे का?" },
  "migration.has_bank": { "en": "Does the SHG currently have an SHG bank account?", "mr": "गटाचे सध्या बँक खाते आहे का?" },
  "migration.bank_balance_warning": { "en": "IMPORTANT: This bank balance refers ONLY to the SHG's own savings/current account. It is NOT the Group Bank Loan. The Group Bank Loan is already captured in Step 5. Do NOT mix these concepts.", "mr": "महत्वाचे: ही बँक शिल्लक फक्त गटाच्या स्वतःच्या बचत/चालू खात्याचा संदर्भ देते. हे गट बँक कर्ज नाही. गट बँक कर्ज आधीच पायरी ५ मध्ये समाविष्ट केले आहे." },
  ...
  "validation.phone_10_digits": { "en": "Phone 10 Digits", "mr": "Phone 10 Digits" },
  "auth.account_not_found": { "en": "Account not found. Please register or check your mobile number.", "mr": "खाते सापडले नाही. कृपया नोंदणी करा किंवा तुमचा मोबाईल नंबर तपासा." },
  "validation.fill_all_fields": { "en": "Fill All Fields", "mr": "Fill All Fields" },
  "auth.passwords_not_match": { "en": "Passwords do not match", "mr": "पासवर्ड जुळत नाहीत" },
  "auth.password_too_short": { "en": "Password must be at least 6 characters", "mr": "पासवर्ड कमीतकमी ६ अक्षरांचा असावा" },
  "auto.mr": { "en": "Mr", "mr": "Mr" },
  "auto.empty": { "en": "Empty", "mr": "Empty" },
  "auto.self_help_group_record_platform": { "en": "Self Help Group Record Platform", "mr": "Self Help Group Record Platform" },
  "common.next": { "en": "Next", "mr": "पुढील" },
  "auth.change_mobile": { "en": "Change Mobile Number", "mr": "मोबाईल नंबर बदला" },
  "auth.welcome_activate": { "en": "Welcome! Create a password to activate your migrated account.", "mr": "स्वागत आहे! तुमचे स्थलांतरित खाते सक्रिय करण्यासाठी पासवर्ड तयार करा." },
  "auth.create_password": { "en": "Create Password", "mr": "पासवर्ड तयार करा" },
  "auth.confirm_password": { "en": "Confirm Password", "mr": "पासवर्डची पुष्टी करा" },
  "auth.activate_account": { "en": "Activate Account", "mr": "खाते सक्रिय करा" },
  "auth.back": { "en": "Back", "mr": "मागे" },
  "validation.enter_group_code": { "en": "Enter Group Code", "mr": "Enter Group Code" },
  "auto.group_code_e_g_shg": { "en": "Group Code E G Shg", "mr": "Group Code E G Shg" },
  "migration.completed": { "en": "Completed (Locked)", "mr": "स्थलांतर पूर्ण झाले (लॉक)" },
  "migration.in_progress": { "en": "In Progress", "mr": "In Progress" },
  "common.cancel": { "en": "Cancel", "mr": "Cancel" },
  "migration.resume": { "en": "Resume", "mr": "Resume" },
  "dashboard.something_went_wrong": { "en": "Something Went Wrong", "mr": "Something Went Wrong" },
  "dashboard.no_speech_detected": { "en": "No Speech Detected", "mr": "No Speech Detected" },
  "dashboard.mic_denied": { "en": "Mic Denied", "mr": "Mic Denied" },
  "dashboard.voice_command": { "en": "Voice Command", "mr": "Voice Command" },
  "reminder.contribution_pending_title": { "en": "Contribution Pending Title", "mr": "Contribution Pending Title" },
  "reminder.within_grace": { "en": "Within Grace", "mr": "Within Grace" },
  "reminder.overdue_by": { "en": "Overdue By", "mr": "Overdue By" },
  "reminder.days": { "en": "Days", "mr": "Days" },
  "reminder.days_remaining": { "en": "Days Remaining", "mr": "Days Remaining" },
  "reminder.contribution_amount": { "en": "Contribution Amount", "mr": "Contribution Amount" },
  "reminder.due_date": { "en": "Due Date", "mr": "Due Date" },
  "reminder.late_fee_applicable": { "en": "Late Fee Applicable", "mr": "Late Fee Applicable" },
  "reminder.no_late_fee": { "en": "No Late Fee", "mr": "No Late Fee" },
  "reminder.total_payable": { "en": "Total Payable", "mr": "Total Payable" },
  "reminder.pay_now": { "en": "Pay Now", "mr": "Pay Now" },
  "reminder.submitted_title": { "en": "Submitted Title", "mr": "Submitted Title" },
  "reminder.submitted_subtitle": { "en": "Submitted Subtitle", "mr": "Submitted Subtitle" },
  "reminder.submitted_amount": { "en": "Submitted Amount", "mr": "Submitted Amount" },
  "reminder.submitted_on": { "en": "Submitted On", "mr": "Submitted On" },
  "reminder.payment_method": { "en": "Payment Method", "mr": "Payment Method" },
  "reminder.view_payment": { "en": "View Payment", "mr": "View Payment" },
  "reminder.rejected_title": { "en": "Rejected Title", "mr": "Rejected Title" },
  "reminder.rejection_reason_label": { "en": "Rejection Reason Label", "mr": "Rejection Reason Label" },
  "reminder.no_reason_given": { "en": "No Reason Given", "mr": "No Reason Given" },
  "reminder.resubmit": { "en": "Resubmit", "mr": "Resubmit" },
  "dashboard.monthly_loan_reminder": { "en": "Monthly Loan Reminder", "mr": "Monthly Loan Reminder" },
  "dashboard.dismiss": { "en": "Dismiss", "mr": "Dismiss" },
  "history.principal_portion": { "en": "Principal Portion", "mr": "Principal Portion" },
  "history.interest_portion": { "en": "Interest Portion", "mr": "Interest Portion" },
  "dashboard.outstanding_interest": { "en": "Outstanding Interest", "mr": "Outstanding Interest" },
  "dashboard.multiple_active_loans": { "en": "Multiple Active Loans", "mr": "Multiple Active Loans" },
  "dashboard.financial_summary": { "en": "Financial Summary", "mr": "Financial Summary" },
  "dashboard.total_savings": { "en": "Total Member Savings (Lifetime)", "mr": "एकूण सभासद बचत (आजपर्यंत)" },
  "dashboard.current_cash_balance": { "en": "Current Cash Balance", "mr": "Current Cash Balance" },
  "dashboard.total_principal_disbursed": { "en": "Total Principal Disbursed", "mr": "Total Principal Disbursed" },
  "dashboard.principal_collected": { "en": "Principal Collected", "mr": "Principal Collected" },
  "dashboard.interest_collected": { "en": "Interest Collected", "mr": "Interest Collected" },
  "dashboard.outstanding_principal": { "en": "Outstanding Principal", "mr": "Outstanding Principal" },
  "dashboard.active_loans": { "en": "Active Loans", "mr": "Active Loans" },
  "dashboard.completed_loans": { "en": "Completed Loans", "mr": "Completed Loans" },
  "dashboard.listening": { "en": "Listening", "mr": "Listening" },
  "dashboard.processing": { "en": "Processing", "mr": "Processing" },
  "auto.permission_to_access_photos_is": { "en": "Permission To Access Photos Is", "mr": "Permission To Access Photos Is" },
  "common.could_not_read_image": { "en": "Could Not Read Image", "mr": "Could Not Read Image" },
  "common.failed_upload_qr": { "en": "Failed Upload Qr", "mr": "Failed Upload Qr" },
  "auto.remove_the_qr_code": { "en": "Remove The Qr Code", "mr": "Remove The Qr Code" },
  "auto.qr_payment_code": { "en": "Qr Payment Code", "mr": "Qr Payment Code" },
  "auto.replace": { "en": "Replace", "mr": "Replace" },
  "auto.uploading": { "en": "Uploading", "mr": "Uploading" },
  "auto.group": { "en": "Group", "mr": "Group" },
  "auto.history": { "en": "History", "mr": "History" },
  "auto.shg_settings": { "en": "Shg Settings", "mr": "Shg Settings" },
  "auto.loan_settings": { "en": "Loan Settings", "mr": "Loan Settings" },
  "auto.group_reports": { "en": "Group Reports", "mr": "Group Reports" },
  "auto.english": { "en": "English", "mr": "English" },
  "common.app_version": { "en": "App Version", "mr": "App Version" },
  "auto.are_you_sure_you_want": { "en": "Are You Sure You Want", "mr": "Are You Sure You Want" },
  "auto.delete": { "en": "Delete", "mr": "Delete" },
  "validation.enter_valid_amount": { "en": "Enter Valid Amount", "mr": "Enter Valid Amount" },
  "auto.no_qr_code_available_contact": { "en": "No Qr Code Available Contact", "mr": "No Qr Code Available Contact" },
  "auto.tap_to_enlarge": { "en": "Tap To Enlarge", "mr": "Tap To Enlarge" },
  "auto.i_have_paid": { "en": "I Have Paid", "mr": "I Have Paid" },
  "auto.tap_anywhere_to_close": { "en": "Tap Anywhere To Close", "mr": "Tap Anywhere To Close" },
  "auto.delete_payment": { "en": "Delete Payment", "mr": "Delete Payment" },
  "auto.this_payment_record_will_be": { "en": "This Payment Record Will Be", "mr": "This Payment Record Will Be" },
  "common.error": { "en": "Error", "mr": "Error" },
  "superAdmin.failed_fetch_groups": { "en": "Failed Fetch Groups", "mr": "Failed Fetch Groups" },
  "validation.group_name_required": { "en": "Group Name Required", "mr": "Group Name Required" },
  "common.success": { "en": "Success", "mr": "Success" },
  "superAdmin.group_created": { "en": "Group Created", "mr": "Group Created" },
  "superAdmin.failed_create_group": { "en": "Failed Create Group", "mr": "Failed Create Group" },
  "superAdmin.failed_update_status": { "en": "Failed Update Status", "mr": "Failed Update Status" },
  "admin.enable_migration": { "en": "Enable Migration", "mr": "Enable Migration" },
  "admin.enable_migration_desc": { "en": "Enable Migration Desc", "mr": "Enable Migration Desc" },
  "admin.migration_completed": { "en": "Completed (Locked)", "mr": "स्थलांतर पूर्ण झाले (लॉक)" },
  "admin.migration_mode": { "en": "Migration Mode", "mr": "स्थलांतर मोड" },
  "auto.super_admin_panel": { "en": "Super Admin Panel", "mr": "Super Admin Panel" },
  "auto.logout": { "en": "Logout", "mr": "Logout" },
  "auto.create_new_shg": { "en": "Create New Shg", "mr": "Create New Shg" },
  "superAdmin.shg_name": { "en": "Shg Name", "mr": "Shg Name" },
  "auto.language": { "en": "Language", "mr": "Language" },
  "superAdmin.generate_code": { "en": "Generate Code", "mr": "Generate Code" },
  "superAdmin.platform_groups": { "en": "Platform Groups", "mr": "Platform Groups" },
  "superAdmin.group_name": { "en": "Group Name", "mr": "Group Name" },
  "superAdmin.code": { "en": "Code", "mr": "Code" },
  "superAdmin.status": { "en": "Status", "mr": "Status" },
  "superAdmin.president": { "en": "President", "mr": "President" },
  "superAdmin.actions": { "en": "Actions", "mr": "Actions" },
  "superAdmin.claimed": { "en": "Claimed", "mr": "Claimed" },
  "superAdmin.unclaimed": { "en": "Unclaimed", "mr": "Unclaimed" },
  "auto.reactivate": { "en": "Reactivate", "mr": "Reactivate" },
  "auto.suspend": { "en": "Suspend", "mr": "Suspend" },
  "migration.title": { "en": "Migration Wizard", "mr": "स्थलांतर विझार्ड" },
  "migration.in_progress_desc": { "en": "In Progress Desc", "mr": "In Progress Desc" },
  "migration.start_fresh": { "en": "Start Fresh", "mr": "Start Fresh" },
  "migration.start": { "en": "Start", "mr": "Start" },
  "migration.step1": { "en": "Step 1", "mr": "पायरी 1" },
  "migration.of_6": { "en": "of 6", "mr": "६ पैकी" },
  "migration.step1_group": { "en": "Group Details", "mr": "गटाची माहिती" },
  "group.formation_date": { "en": "Formation Date", "mr": "गट स्थापना तारीख" },
  "bank.registration_number_optional": { "en": "Bank Registration Number (Optional)", "mr": "बँक नोंदणी क्रमांक (ऐच्छिक)" },
  "bank.registration_number": { "en": "Bank Registration Number", "mr": "बँक नोंदणी क्रमांक" },
  "bank.bank_linked": { "en": "Is the SHG Bank Linked?", "mr": "गट बँकेशी जोडला आहे का?" },
  "bank.name": { "en": "Bank Name", "mr": "बँकेचे नाव" },
  "bank.ifsc": { "en": "IFSC Code", "mr": "IFSC कोड" },
  "bank.account_number": { "en": "Account Number", "mr": "बँक खाते क्रमांक" },
  "migration.step2": { "en": "Step 2", "mr": "Step 2" },
  "migration.step2_snapshot": { "en": "Current SHG Financial Position", "mr": "सध्याची बचत गट आर्थिक स्थिती" },
  "migration.snapshot_date": { "en": "Migration Date", "mr": "स्थलांतर तारीख" },
  "migration.cash_balance_desc": { "en": "Cash physically available with the SHG today.", "mr": "आज बचत गटाकडे प्रत्यक्ष उपलब्ध असलेली रोख रक्कम." },
  "migration.bank_balance_desc": { "en": "Money currently available in the SHG bank account. This is NOT the outstanding bank loan.", "mr": "बचत गटाच्या बँक खात्यात सध्या उपलब्ध असलेली रक्कम. हे थकीत बँक कर्ज नाही." },
  "migration.total_savings_desc": { "en": "Total savings collected from all members up to the migration date.", "mr": "स्थलांतराच्या तारखेपर्यंत सर्व सदस्यांकडून गोळा केलेली एकूण बचत." },
  "migration.step3": { "en": "Step 3", "mr": "पायरी ३" },
  "migration.step3_members": { "en": "Current Members", "mr": "सध्याचे सदस्य" },
  "migration.step3_desc": { "en": "Verify the list of members.", "mr": "सदस्यांच्या यादीची पडताळणी करा." },
  "migration.add_member": { "en": "Add Member", "mr": "सदस्य जोडा" },
  "member.name": { "en": "Name", "mr": "नाव" },
  "member.phone": { "en": "Phone", "mr": "फोन" },
  "member.role": { "en": "Role", "mr": "भूमिका" },
  "role.president": { "en": "President", "mr": "अध्यक्ष" },
  "role.secretary": { "en": "Secretary", "mr": "सचिव" },
  "role.treasurer": { "en": "Treasurer", "mr": "खजिनदार" },
  "role.member": { "en": "Member", "mr": "सदस्य" },
  "migration.remove": { "en": "Remove", "mr": "काढा" },
  "migration.step4": { "en": "Step 4", "mr": "पायरी ४" },
  "migration.step4_savings": { "en": "Savings Verification", "mr": "बचत पडताळणी" },
  "migration.step4_desc": { "en": "Verify member savings.", "mr": "सदस्य बचतीची पडताळणी करा." },
  "migration.distribute_evenly": { "en": "Distribute Evenly", "mr": "समान वाटप करा" },
  "migration.savings_balance": { "en": "Savings Balance", "mr": "बचत शिल्लक" },
  "migration.sum_error": { "en": "Sum Error", "mr": "बेरीज त्रुटी" },
  "migration.step5": { "en": "Step 5", "mr": "पायरी ५" },
  "migration.step5_loans": { "en": "Current Internal Loans", "mr": "सध्याचे अंतर्गत कर्ज" },
  "migration.step5_desc": { "en": "Verify internal loans.", "mr": "अंतर्गत कर्जाची पडताळणी करा." },
  "migration.add_internal_loan": { "en": "Add Internal Loan", "mr": "अंतर्गत कर्ज जोडा" },
  "migration.add_bank_loan": { "en": "Add Bank Loan", "mr": "बँक कर्ज जोडा" },
  "loan.amount": { "en": "Amount", "mr": "रक्कम" },
  "loan.principal_paid": { "en": "Principal Paid", "mr": "परत केलेली मुद्दल" },
  "loan.interest_paid": { "en": "Interest Paid", "mr": "परत केलेले व्याज" },
  "loan.interest_rate": { "en": "Interest Rate", "mr": "व्याजदर" },
  "loan.installments": { "en": "Installments", "mr": "हप्ते" },
  "loan.member": { "en": "Member", "mr": "सदस्य" },
  "loan.bank_loan_ref": { "en": "Bank Loan Ref", "mr": "बँक कर्ज संदर्भ" },
  "loan.purpose": { "en": "Purpose", "mr": "उद्देश" },
  "migration.step6": { "en": "Step 6", "mr": "पायरी ६" },
  "migration.step6_review": { "en": "Review", "mr": "पुनरावलोकन" },
  "migration.step6_desc": { "en": "Review all details before finalizing.", "mr": "अंतिम करण्यापूर्वी सर्व तपशीलांचे पुनरावलोकन करा." },
  "migration.group_summary": { "en": "Group Summary", "mr": "गटाचा सारांश" },
  "migration.financial_summary": { "en": "Financial Summary", "mr": "आर्थिक सारांश" },
  "migration.members_summary": { "en": "Members Summary", "mr": "सदस्यांचा सारांश" },
  "migration.loans_summary": { "en": "Loans Summary", "mr": "कर्जाचा सारांश" },
  "migration.total_bank_loans": { "en": "Total Bank Loans", "mr": "एकूण बँक कर्ज" },
  "migration.total_internal_loans": { "en": "Total Internal Loans", "mr": "एकूण अंतर्गत कर्ज" },
  "migration.confirm_warning": { "en": "Are you sure? This action cannot be undone.", "mr": "तुम्हाला खात्री आहे का? ही कृती परत घेता येणार नाही." },
  "migration.complete": { "en": "Complete Migration", "mr": "स्थलांतर पूर्ण करा" },
  "migration.save_exit": { "en": "Save & Exit", "mr": "सेव्ह करा आणि बाहेर पडा" },
  "validation.savings_mismatch": { "en": "Savings amount does not match the total.", "mr": "बचतीची रक्कम एकूणाशी जुळत नाही." },
  "common.save": { "en": "Save", "mr": "सेव्ह करा" },
  "bank.sanction_amount": { "en": "Sanction Amount", "mr": "Sanction Amount" },
  "bank.emi_amount": { "en": "Emi Amount", "mr": "Emi Amount" },
  "bank.loan_number": { "en": "Loan Number", "mr": "Loan Number" },
  "bank.sanction_date": { "en": "Sanction Date", "mr": "Sanction Date" },
  "migration.warning_duplicate_res": { "en": "Warning Duplicate Res", "mr": "Warning Duplicate Res" },
  "migration.warning_duplicate_sanction": { "en": "Warning Duplicate Sanction", "mr": "Warning Duplicate Sanction" },
  "migration.warning_negative_balance": { "en": "Warning Negative Balance", "mr": "Warning Negative Balance" },
  "migration.warnings": { "en": "Warnings", "mr": "Warnings" },
  "migration.total_members": { "en": "Total Members", "mr": "Total Members" },
  "migration.total_principal": { "en": "Total Principal", "mr": "Total Principal" },
  "common.back": { "en": "Back", "mr": "मागे" },

  "migration.validation_failed": { "en": "Validation Failed", "mr": "प्रमाणीकरण अयशस्वी" },
  "migration.step4_loans": { "en": "Current Internal Loans", "mr": "सध्याचे अंतर्गत कर्ज" },
  "migration.step5_bank_loans": { "en": "Current Bank Loans", "mr": "सध्याचे बँक कर्ज" },
  "migration.step7_finish": { "en": "Finish", "mr": "पूर्ण" },
  "migration.step": { "en": "Step", "mr": "पायरी" },
  "migration.of": { "en": "of", "mr": "पैकी" },
